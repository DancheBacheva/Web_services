...
//"getCharacter" e asinhrona funkcija koja se povikuva na rutata "/api/v1/rickandmorty/character/:id"
//ne` povrzuva so url-to za prezemanje podatoci od API-tо RickN'Morty
exports.getData = async (req, res) => {
  let url = `https://rickandmortyapi.com/api/character`;
//prvo proveruva dali ima keshirani podatoci za daden ID. Ako keshiranite podatoci postojat i ne se zastareni, localCache se setira da bide null, odnosno da gi izbrishe podatocite zacuvani od prethodno
